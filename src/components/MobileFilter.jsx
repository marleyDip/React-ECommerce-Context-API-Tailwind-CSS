...
const MobileFilter = ({
  ...
  return (
    <>
      <div className="md:hidden bg-gray-100 flex items-center justify-between px-4 py-2 mt-5">
      ...
      {openFilter ? (
        <div className="bg-gray-100 p-4 md:hidden">
          ...
          <input
            ...
            placeholder="Search..."
            className="w-full bg-white p-2 rounded-md shadow-md border-2 border-gray-400 focus:border-transparent focus:ring-2 focus:ring-orange-600 focus:outline-none focus:ring-offset-0"
          />
          {/* search */}
          ...
          <div className="flex flex-col gap-2 w-[240px] font-medium">
            <label htmlFor="">
